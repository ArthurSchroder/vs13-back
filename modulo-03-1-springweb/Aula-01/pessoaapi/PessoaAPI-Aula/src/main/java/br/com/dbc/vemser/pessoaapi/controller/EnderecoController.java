...
import java.util.List;
    ...
    public class EnderecoController {
        ...
        public ResponseEntity<?> enderecoById(@RequestParam("id-endereco") Integer idEndereco) {
            try {
        ...
        public ResponseEntity<List<EnderecoDTO>> listByPessoa(@RequestParam("id-pessoa") Integer id) {
        ...
        public ResponseEntity<?> createByPessoa(@RequestParam("idPessoa") Integer id,
        ...
        public ResponseEntity<?> update(@PathVariable("idEndereco") Integer id,
